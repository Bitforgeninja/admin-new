...
function PlatformSettings() {
    ...
    const fetchSettings = async () => {
      try {
        ...
        setSettings({
          ...
          qrCodeUrl: qrCodeUrl ? qrCodeUrl + '?v=' + Date.now() : '',
          bannerImageUrl: bannerImageUrl ? bannerImageUrl + '?v=' + Date.now() : '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      window.location.reload(); // 🔁 Force image refresh
    } catch (error) {
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              ...
              <img src={settings.qrCodeUrl} alt="QR Code" style={{ width: '100px', height: '100px' }} />
            </li>
            <li>
              <strong>Banner Image:</strong><br />
              <img src={settings.bannerImageUrl} alt="Banner" style={{ width: '300px', height: '100px' }} />
            </li>
          </ul>
        </div>
        <div>
